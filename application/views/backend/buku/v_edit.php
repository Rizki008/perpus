						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_buku" value="<?= $buku->no_buku ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="No Buku">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="judul" value="<?= $buku->judul ?>" class=" form-control" id="exampleInputPassword1" placeholder="Judul Buku">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="pengarang" value="<?= $buku->pengarang ?>" class=" form-control" id="exampleInputPassword1" placeholder="Pengarang Buku">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="penerbit" value="<?= $buku->penerbit ?>" class=" form-control" id="exampleInputPassword1" placeholder="Penerbit Buku">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="isbn" value="<?= $buku->isbn ?>" class=" form-control" id="exampleInputPassword1" placeholder="ISBN Buku">
