				...
				<div class="ibox">
					<div class="ibox-body">
						...
						<div>
							...
							?>
							<canvas id="sisisa" style="height:260px;"></canvas>
							<script>
								var ctx = document.getElementById('sisisa');
								var myChart = new Chart(ctx, {
									type: 'bar',
									data: {
				...
				<div class="ibox">
					<div class="ibox-body">
						...
						<div>
							...
							?>
							<canvas id="susisaska" style="height:260px;"></canvas>
							<script>
								var ctx = document.getElementById('susisaska');
								var myChart = new Chart(ctx, {
									type: 'bar',
									data: {
